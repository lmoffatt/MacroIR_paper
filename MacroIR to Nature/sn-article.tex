...
Thus, plotting the kinetic coupling factors on a log–log scale not only delineates shifts in equilibrium constants but also reveals modifications of the energy barriers underlying the transitions. Regular allosteric couplings appear in the lower right quadrant, catalytic allosterism—where both \textit{on} and \textit{off} rates are enhanced—emerges in the upper right quadrant, and a distinct modulation, here described as inhibitory allosterism, appears in the lower left quadrant. This classification provides a straightforward and visually intuitive framework for deciphering the multifaceted nature of allosteric modulation in these receptors.
\section{Structural Basis of Kinetic Rate Modulation}
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=\linewidth]{Figure_3_scheme_10.pdf}
