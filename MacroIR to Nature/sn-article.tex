...
Data analyzed in this study derive from our previous work \cite{Moffatt_hume}, comprising a unique dataset of macroscopic current responses to 0.2\,ms ATP pulses at concentrations ranging from 0.1 to 10\,mM. By combining ultrashort ATP-pulse electrophysiology with our MacroIR framework and conformational models, we demonstrate that ATP binding preferentially lowers the rotational barrier of one subunit while imposing kinetic constraints on its neighbor. This work establishes kinetic asymmetry as a core principle of P2X2 gating and advances our understanding of dynamic structural mechanisms, with implications for rational therapeutic design.
