...
Traditional allosteric models are based on thermodynamic considerations and thus treat coupling as a single factor that multiplies equilibrium constants. When extending this formalism to kinetic models, however, two factors—one for each conformational change—are required.

Our kinetic schemes propose two distinct allosteric coupling mechanisms, depending on whether the modulation involves the subunit to the left (BR, Binding-Rotation) or the subunit to the right (RB, Rotation-Binding) of the ATP binding site. Or, equivalently, the binding site at the right (BR) or the left of the rotating subunit.  Figure~\ref{fig:rates_SchemeX}a depicts the conformational couplings affecting binding in a cubic arrangement of three coupled transitions—agonist binding, left subunit rotation, and right subunit rotation. To underscore the correspondence between model states and channel structures, we adopted schematic representations from the study that resolved the open-channel structure of a purinergic receptor \cite{abierta_p2x}. In this schematic, each vertex represents a distinct receptor state (ranging from unrotated/free/unrotated to rotated/bound/rotated), and the edges are annotated with the corresponding kinetic expressions. In the absence of ATP, both subunits rotate at identical rates; however, ATP binding breaks this symmetry. Notably, when both subunits are rotated, the binding and unbinding rates are multiplied by the product of both RB and BR couplings. Similarly, in a cubic arrangement of left site binding, subunit rotation, and right site binding (not shown), the rotation rates of a subunit with both sites occupied are multiplied by both RB and BR factors.

Traditional allosteric models are based on thermodynamic considerations and thus treat coupling as a single factor that multiplies equilibrium constants. When extending this formalism to kinetic models, however, two factors—one for each conformational change—are required. 
Our kinetic schemes propose two distinct allosteric coupling mechanisms, depending on whether the modulation involves the subunit to the left (BR, Binding-Rotation) or the subunit to the right (RB, Rotation-Binding) of the ATP binding site. Figure~\ref{fig:rates_SchemeX}a depicts the conformational couplings affecting binding in a cubic arrangement of three coupled transitions—agonist binding, left subunit rotation, and right subunit rotation. To underscore the correspondence between model states and channel structures, we adopted schematic representations from the study that resolved the open-channel structure of a purinergic receptor \cite{abierta_p2x}. In this schematic, each vertex represents a distinct receptor state (ranging from unrotated/free/unrotated to rotated/bound/rotated), and the edges are annotated with the corresponding kinetic expressions. In the absence of ATP, both subunits rotate at identical rates; however, ATP binding breaks this symmetry. Notably, when both subunits are rotated, the binding and unbinding rates are multiplied by the product of both RB and BR couplings. Similarly, in a cubic arrangement of left site binding, subunit rotation, and right site binding (not shown), the rotation rates of a subunit with both sites occupied are multiplied by both RB and BR factors. 

Traditional allosteric models are based on thermodynamic considerations and thus treat coupling as a single parameter that modifies equilibrium constants. When extending this formalism to kinetic models, we need to employs two parameters—one for each conformational change—to accurately capture the kinetic modulation. 
Our kinetic schemes propose two distinct allosteric coupling mechanisms, depending on whether modulation involves the subunit to the left (BR, Binding-Rotation) or the subunit to the right (RB, Rotation-Binding) of the ATP binding site.  Figure~\ref{fig:rates_SchemeX}a depicts the conformational couplings that affects binding in a cubic arrangement of three coupled conformational transitions—agonist binding, left subunit rotation, and right subunit rotation. To underscore the correspondence between model states and channel structures, we adopted schematic representations from the study that resolved the open-channel structure of a purinergic receptor \cite{abierta_p2x}. Each vertex represents a distinct receptor state (ranging from unrotated/free/unrotated to rotated/bound/rotated), and the edges are annotated with the corresponding kinetic expressions. In the absence of ATP, both subunits rotate at identical rates; however, ATP binding breaks this symmetry. Notice that when both subunits are rotated, the binding and unbinding rates are multiplied by the product of both RB and BR couplings. In an analogous cubic arrangement of left site binding, subunit rotation and right site binding, the rotation rates of a subunit with both sites occupied would be multiplied by both RB and BR factors for rotation. 

Traditional allosteric models are built from thermodynamic considerations and therefore treat coupling as a single parameter that modifies equilibrium constants. When we extend this formalism to kinetic models, it is clear that because of microscopic reversibility, a single parameter govern the dependence of both coupled conformational changes, but we use two  parameters to describe the coupling of each conformational change. Each conformational change—binding, rotation, and gating—is governed by its own coupling parameter, which requires two additional parameters to fully describe the kinetic modulation.

Our kinetic schemes propose two distinct allosteric coupling mechanisms depending on whether modulation involves the subunit to the left (BR, Binding-Rotation) or to the right (RB, Rotation-Binding) of the ATP binding site. Figure~\ref{fig:rates_SchemeX}a illustrates this concept. To underscore the correspondence between model states and channel structures, we adopted schematic representations from the study that resolved the open-channel structure of a purinergic receptor \cite{abierta_p2x}. That work proposed that ATP binding is accompanied by rotation of both ligand-contacting subunits; here, we extend that view by assuming that subunits can rotate independently rather than synchronously, with ATP binding modulating these subtle conformational changes. Figure~\ref{fig:rates_SchemeX}a depicts a cubic arrangement of three coupled conformational transitions—agonist binding, left subunit rotation, and right subunit rotation. Each vertex represents a distinct receptor state (ranging from unrotated/free/unrotated to rotated/bound/rotated), and the edges are annotated with the corresponding kinetic expressions. In the absence of ATP, both subunits rotate at identical rates; ATP binding, however, breaks this symmetry. (This schematic is simplified, as additional binding sites would introduce further allosteric factors.)
