...
\begin{table}[h]
	...
	\begin{tabular}{c|c|c|c}
		...
		RB & 632.661 & 0.1441125 & $3.918861 \times 10^{3}$ \\ 
		$RB_{rot}$ & $2.454486 \times 10^{4}$ & 1.260341 & $1.401152 \times 10^{5}$ \\ 
		\rowcolor[HTML]{efefef} 
		$RB_{bon}$ & 6.248909 & $1.933688 \times 10^{-6}$ & 38.56124 \\ 
		BR & 1.612385 & 0.2657464 & $1.106451 \times 10^{3}$ \\ 
		\rowcolor[HTML]{efefef} 
		$BR_{rot}$ & 2.241492 & 1.077178 & $3.979711 \times 10^{4}$ \\ 
		$BR_{bon}$ & $6.986098 \times 10^{-3}$ & $9.626552 \times 10^{-7}$ & 11.16657 \\ 
		\hline
		\hline
	\end{tabular}
\end{table}
