...
While the activation kinetic profile could, in principle, be achieved without barrier modulation by simply initiating from higher basal turnover rates, the differential modulation we observed entails an increase in the energy barrier for resting-state rotation. This elevated barrier limits the time the channel spends in a transitional conformation in the absence of agonist, likely reducing the risk of spontaneous inactivation. Conversely, decreasing both the rotation and unrotation rates increases the time constant of unliganded gating noise, thereby rendering it detectable by our analysis.
